...
class EnvPmdkTest : public testing::Test {
 public:
  ...
  EnvPmdkTest() : env_(Env::Default()) {}

  Env* env_;
};

TEST_F(EnvPmdkTest, TestOpenOnRead) {
...
TEST_F(EnvPmdkTest, TestCloseOnExecSequentialFile) {
  std::unordered_set<int> open_fds;
  GetOpenFileDescriptors(&open_fds);
...
TEST_F(EnvPmdkTest, TestCloseOnExecRandomAccessFile) {
  std::unordered_set<int> open_fds;
  GetOpenFileDescriptors(&open_fds);
...
TEST_F(EnvPmdkTest, TestCloseOnExecWritableFile) {
  std::unordered_set<int> open_fds;
  GetOpenFileDescriptors(&open_fds);
...
TEST_F(EnvPmdkTest, TestCloseOnExecAppendableFile) {
  std::unordered_set<int> open_fds;
  GetOpenFileDescriptors(&open_fds);
...
TEST_F(EnvPmdkTest, TestCloseOnExecLockFile) {
  std::unordered_set<int> open_fds;
  GetOpenFileDescriptors(&open_fds);
...
TEST_F(EnvPmdkTest, TestCloseOnExecLogger) {
  std::unordered_set<int> open_fds;
  GetOpenFileDescriptors(&open_fds);
...
int main(int argc, char** argv) {
  ...
  leveldb::EnvPmdkTest::SetFileLimits(leveldb::kReadOnlyFileLimit,
                                       leveldb::kMMapLimit);
